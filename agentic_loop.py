...
def get_implementation_agent_advice(observe_message):
    ...
    system_task = load_prompt("implementation_task_prompt.txt")
    ...
    return call_model(IMPLEMENTATION_MODEL, system_prompt, f"{system_task}\n\m{observe_message}")
...
def get_review_agent_advice(implementation_message, observe_message):
    ...
    return call_model(REVIEW_MODEL, review_system_prompt, f"{review_task_prompt}\n\n{observe_message}")
